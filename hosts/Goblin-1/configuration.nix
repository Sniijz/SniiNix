...
let
  ...
  customK3S =
    pkgs.runCommand "k3s-1.34.1"
      {
        src = pkgs.fetchurl {
          url = "https://github.com/k3s-io/k3s/releases/download/v1.34.1%2Bk3s1/k3s";
          sha256 = "18zng0mkb5409r937avg678dpc043i0y7d98w182v8v32gz5i2gc";
        };
      }
      ''
        mkdir -p $out/bin
...
in
{
  ...
  # KEEP IT LIKE THIS ON GOBLIN-1, THIS ONE HAS BEEN UPGRADED FROM 24.05, GOBLIN-1
  ...
  fileSystems."/mnt/hdd1" = {
    device = "/dev/disk/by-uuid/bfef42dc-91eb-43f7-b6ff-e9913cd1ab36";
    fsType = "ext4";
  };
